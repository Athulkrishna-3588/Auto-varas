...
const Valanbusiness = () => {
  return (
    <div className="container my-6 flex mx-10">
        <div className="business  my-6 flex">
            <div className="business-text my-32 mx-14">
            <h1 className="text-4xl">The Valan you</h1>
            <h1 className="text-4xl">know, remained</h1>
            <h1 className="text-4xl">for business</h1>
            <p className="my-6">Valan for Business is a platform for managing global rides and <br />
          ...
          >Get started</button>
            <p className="my-3 mx-6">Check out our solutions</p>
            </div>
            <div className="business-img">
                <img className="h-[250px] w-[500px] rounded-lg"  src="../images/business.jpg" alt="" />
            </div>
        </div>
    </div>
  )
