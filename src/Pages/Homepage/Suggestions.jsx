  ...
  return (
    <div className="container my-6 flex mx-10">
        <div className="suggestions flex m-auto gap-5">
            ...
            className="ride flex bg-gray-300 hover:bg-white hover:scale-110 duration-300 hover:shadow-sm  rounded-xl justify-evenly p-5">
            ...
            className="ride flex bg-gray-300  rounded-xl justify-evenly p-5">
                <div className=" text-left px-3 my3">
